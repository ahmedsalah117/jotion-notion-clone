...
interface PublishDocBtnProps {
    initialData: Doc<"documents"> ;
}

const PublishDocBtn = ({ initialData }: PublishDocBtnProps) => {
  ...
  return (
    <Popover>
      ...
      <PopoverContent className='w-72' align='end' alignOffset={6} forceMount>
